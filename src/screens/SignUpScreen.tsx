...
const SignUpScreen: FC<{}> = () => {
    ...
    const handleSignUp = async (val: any) => {                
        try {
          const userCredential = await auth().createUserWithEmailAndPassword(val?.email, val.password);
                ...
                {({ handleChange, handleBlur, handleSubmit, values, errors, touched }) => (
                    <>
                        ...
                        <TouchableOpacity onPress={() => navigation.navigate('Login')}>
                            <Text style={styles.facebookButtonText}>Don't have an account? Login up</Text>
                        </TouchableOpacity>
                    </>
                )}
            </Formik>
